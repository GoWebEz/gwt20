                ...
                <div class="container-fluid"><button class="navbar-toggler" type="button"
                    ...
                    <div class="collapse navbar-collapse" id="navbarTogglerDemo01">
                        <ul class="navbar-nav  px-2 main_menu">
                            <li class="nav-item py-md-1 my-2 my-lg-0 px-3 activeMenu   mx-lg-1 "><a
                            ...
                            <li class="nav-item py-md-1 px-3   mx-lg-1"><span
                                    class="nav-link text-dark"><span class="pe-2"><i
                                            class="fa-solid fa-lock"></i></span>ADMIN</span>
                                <ul class="dropdown shadow">
                                    <li class=""><a class="text-dark" href="/admin/users.html">Users</a></li>
                                    <li class=""><a class="text-dark" href="/admin/clients">Clients</a></li>
                                    <li class=""><a class="text-dark" href="/admin/devices.html">Devices</a>
                                    </li>
                                    <li class=""><a class="text-dark" href="/admin/locations.html">Locations</a>
                                    </li>
                                    <li class="activeMenu"><a class="text-white active"
