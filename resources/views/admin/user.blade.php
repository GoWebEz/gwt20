        ...
        <div class="landing w-100">
            <div class="container-lg">
                <div class="d-flex align-items-center title">
                    <h3 class="title-text m-0 me-1">User List</h3>
                    ...
                    <ul class="nav nav-pills" id="myTab" role="tablist">
                        <li class="nav-item " role="presentation"><a
                                ...
                                aria-controls="home" data-name="activeTab" aria-selected="true"><img
                                    ...
                                    class="mx-1" width="17px">Active Users</a></li>
                        <li class="nav-item " role="presentation"><a
                                ...
                                aria-controls="home" data-name="inActiveTab" aria-selected="false"><img
                                    ...
                                    class="mx-1" width="20px">Inactive Users</a></li>
                    </ul>
                    <div
                        ...
                        <div class="addUserBtn"><button id="add-modal-close"
                                class="btn addUser-btn text-white px-2" data-bs-toggle="modal"
                                data-bs-target="#addUserModal"><span class="pe-2"><i
                                        class="fa-solid fa-circle-plus text-white"></i></span>Add User</button>
                                ...
                                <div
                                    ...
                                    <div class=" modal-content text-decoration-none border-0">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Add User</h5><button
                                                type="button" class="btn-close text-white"
                                            ...
                                            <form>
                                                <div class="row">
                                                    <div class="my-2  col-md-6 position-relative form-group">
                                                        <label class="py-2 fs-6">First Name</label><input
                                                            type="text" placeholder="Enter First Name"
                                                            name="first_name" class="form-control w-md-100 "
                                                            data-name="name" value="">
                                                        <div class="position-absolute"></div>
                                                    </div>
                                                    <div class="my-2  col-md-6 position-relative form-group">
                                                        <label class="py-2 fs-6">Last Name</label><input
                                                            type="text" placeholder="Enter Last Name"
                                                            name="last_name" class="form-control w-md-100 "
                                                            data-name="name" value="">
                                                        <div class="position-absolute"></div>
                                                    </div>
                                                    <div class="my-2  col-md-6 position-relative form-group">
                                                        <label class="py-2 fs-6">Username</label><input
                                                            type="text" placeholder="Enter Username"
                                                            name="user_name" class="form-control w-md-100 "
                                                            data-name="name" value="">
                                                        <div class="position-absolute"></div>
                                                    </div>
                                                    <div class="my-2  col-md-6 position-relative form-group">
                                                        <label class="py-2 fs-6">Email Address</label><input
                                                            type="text" placeholder="Enter Email Address"
                                                            name="email" class="form-control w-md-100 "
                                                            data-name="email" value="">
                                                        <div class="position-absolute"></div>
                                                    </div>
                                                    <div class="my-2  col-md-6 position-relative form-group">
                                                        <label class="py-2 fs-6">Phone</label><input type="text"
                                                            placeholder="Enter Phone Number" name="phone"
                                                            class="form-control w-md-100 " data-name="phone"
                                                            value="">
                                                        <div class="position-absolute"></div>
                                                    </div>
                                                    <div class="my-2  col-md-6 position-relative"><label
                                                            class="undefined py-2 fs-6">Role</label><select
                                                    ...
                                                    <div class="my-2  col-md-6 position-relative"><label
                                                            class="undefined py-2 fs-6">Designation</label><select
                                                            class="form-select form-control "
                                                            name="designation_name" data-value="">
                            ...
                            <table class="table align-middle table-borderless mb-0">
                                ...
                                <tbody class="tbody">
                                    {{-- <tr class="recordNotFound mt-3 text-nowrap">
                                        <td colspan="6" class="text-center noRecordFound">
                ...
                <div class="modal fade" id="editUserModal" tabindex="-1" aria-labelledby="exampleModalLabel"
                    ...
                    <div class=" modal-dialog modal-lg d-flex justify-content-center align-items-center">
                        <div class=" modal-content text-decoration-none border-0">
                            <div class="modal-header">
                                <h5 class="modal-title" id="exampleModalLabel">Edit User</h5><button
                                ...
                                <form>
                                    <div class="row">
                                        <div class="my-2  col-md-6 position-relative form-group"><label
                                                class="py-2 fs-6">Username</label><input type="text"
                                                placeholder="Enter Username" name="user_name"
                                                class="form-control w-md-100 " data-name="dis-name" readonly=""
                                                value="">
                                            <div class="position-absolute"></div>
                                        </div>
                                        <div class=" my-2  col-md-6 position-relative form-group"><label
                                        ...
                                        <div class="my-2  col-md-6 position-relative form-group"><label
                                                class="py-2 fs-6">First Name</label><input type="text"
                                                placeholder="Enter First Name" name="first_name"
                                                class="form-control w-md-100 " data-name="name" value="">
                                            <div class="position-absolute"></div>
                                        </div>
                                        <div class="my-2  col-md-6 position-relative form-group"><label
                                                class="py-2 fs-6">Last Name</label><input type="text"
                                                placeholder="Enter Last Name" name="last_name"
                                                class="form-control w-md-100 " data-name="name" value="">
                                            <div class="position-absolute"></div>
                                        </div>
                                        <div class="my-2  col-md-6 position-relative form-group"><label
                                                class="py-2 fs-6">Phone</label><input type="text"
                                                placeholder="Enter Phone Number" name="phone"
                                                class="form-control w-md-100 " data-name="phone" value="">
                                            <div class="position-absolute"></div>
                                        </div>
                                        <div class="my-2  col-md-6 position-relative"><label
                                                class="undefined py-2 fs-6">Role</label><select
                                        ...
                                        <div class="my-2  col-md-6 position-relative"><label
                                                class="undefined py-2 fs-6">Designation</label><select
                                                class="form-select form-control " name="designation_name"
                                                data-value="">
                                                <option value="">Select Designation</option>
                                            </select>
                                            <div class="position-absolute"></div>
                ...
                <div class="modal fade" id="permanentDeleteUserModal" tabindex="-1"
                    aria-labelledby="exampleModalLabel" aria-hidden="true" data-bs-backdrop="static"
                    data-bs-keyboard="false">
                    <div class=" modal-dialog modal-lg d-flex justify-content-center align-items-center">
                        <div class=" modal-content text-decoration-none border-0">
